...
export default {
  ...
  computed: {
    createMap() {
      ...
      "esri/layers/OpenStreetMapLayer","esri/views/SceneView",
      "esri/widgets/Expand",
      "esri/widgets/Legend", 
      "esri/widgets/LayerList",
      "esri/widgets/Search" 
      ], (MapView, WebMap, Map, OpenStreetMapLayer, SceneView, Expand, Legend, LayerList, Search) => {
  ...
  mounted() {    
    if (!esriLoader.isLoaded()) {
      esriLoader.bootstrap((err) => {
        ...
        url: 'http://localhost:8080/arcgis_js_api/library/4.3/4.3/init.js'//'https://js.arcgis.com/4.3/'
      });
    } else {
      this.createMap();
    }
